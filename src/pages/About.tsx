    ...
    <div className="pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-12">
          ...
          <h1 className="text-5xl md:text-7xl font-headline font-bold text-charcoal tracking-tighter mb-8 leading-[0.9]">
            <AnimatedText text={t('about_title')} />
          </h1>
          <p className="text-xl md:text-2xl text-charcoal/60 font-medium leading-relaxed max-w-2xl">
            {t('about_subtitle')}
          </p>
        </div>
        ...
        <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={i} className="text-center p-8 bg-charcoal/2 rounded-2xl border border-charcoal/5">
              ...
              <div className="text-xs font-label font-bold text-charcoal/40 tracking-widest uppercase">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
